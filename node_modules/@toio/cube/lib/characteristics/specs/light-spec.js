...
var LightSpec = (function () {
    ...
    LightSpec.prototype.turnOnLight = function (operation) {
        var duration = util_1.clamp(operation.durationMs / 10, 0, 255);
        var red = util_1.clamp(operation.red, 0, 255);
        var green = util_1.clamp(operation.green, 0, 255);
        var blue = util_1.clamp(operation.blue, 0, 255);
        return {
