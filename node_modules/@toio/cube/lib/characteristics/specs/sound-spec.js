...
var SoundSpec = (function () {
    function SoundSpec() {
    }
    SoundSpec.prototype.playPresetSound = function (soundId) {
        var arrangedSoundId = util_1.clamp(soundId, 0, 10);
        return {
    ...
    SoundSpec.prototype.playSound = function (operations, repeatCount) {
        var arrangedData = {
            operations: [],
            repeatCount: util_1.clamp(repeatCount, 0, 255),
            totalDurationMs: 0,
        };
        ...
        for (var i = 0; i < numOperations; i++) {
            ...
            var duration = util_1.clamp(operation.durationMs / 10, 1, 255);
            ...
            buffer.writeUInt8(duration, 3 + 3 * i);
            buffer.writeUInt8(noteName, 4 + 3 * i);
            buffer.writeUInt8(255, 5 + 3 * i);
        }
...
//# sourceMappingURL=sound-spec.js.map